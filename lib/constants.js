...
export const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .current-string-card, .improve-card { border-radius: 12px; padding: 22px; margin-bottom: 20px; }
  ...
  .current-string-title, .improve-title { font-family: 'Bebas Neue', sans-serif; font-size: 20px; letter-spacing: 1px; margin-bottom: 14px; display: flex; align-items: center; gap: 8px; }
