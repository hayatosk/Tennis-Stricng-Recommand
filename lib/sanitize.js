...
function sanitizeSwingAnalysis(analysis) {
  ...
  return {
    stroke_type: sanitizeNullableText(analysis.stroke_type, 20),
    stroke_label: sanitizeNullableText(analysis.stroke_label, 20),
    handedness: sanitizeNullableText(analysis.handedness, 20),
    stroke_confidence: sanitizeNullableText(analysis.stroke_confidence, 20),
...
export function sanitizeForm(rawForm) {
  return {
    ...
    current_shape: sanitizeNullableText(rawForm.current_shape, 30),
    current_gauge: sanitizeNullableText(rawForm.current_gauge, 30),
    cross_gauge: sanitizeNullableText(rawForm.cross_gauge, 30),
    cross_string: sanitizeNullableText(rawForm.cross_string, 80),
    cross_shape: sanitizeNullableText(rawForm.cross_shape, 30),
